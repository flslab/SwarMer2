...
def_conf = {
    ...
    "FILE_NAME_KEYS": "[('GROUP_TYPE', 'V'), ('DEAD_RECKONING_ANGLE', 'D'), ('SS_ERROR_PERCENTAGE', 'X')]",
    "DIR_KEYS": "[]",
}
...
props = [
    {
        ...
        "values": [
            ...
            # {"SHAPE": "'palm_725_50_spanning_2'", "GROUP_TYPE": "'spanning_2_v2'"},
            ...
            # {"SHAPE": "'kangaroo_972_50_spanning_2'", "GROUP_TYPE": "'spanning_2_v2'"},
            ...
            # {"SHAPE": "'dragon_1147_50_spanning_2'", "GROUP_TYPE": "'spanning_2_v2'"},
